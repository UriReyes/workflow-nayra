        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('process.store') }}" method="post" class="grid grid-cols-12">
                        @csrf
                        <div class="col-span-12">
                            ...
                            <p class="m-0 text-gray-500"><small>El nombre del proceso debe ser único</small></p>
                            @error('name')
                        ...
                        <div class="col-span-12 mt-2">
                            ...
                            <p class="m-0 text-gray-500"><small>Descripción del proceso</small></p>
                            @error('description')
                                <p class="text-red-500"><small>{{ $message }}</small></p>
                            @enderror
                        </div>
